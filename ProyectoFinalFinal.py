...
def calculaCosto():
    salida=open("PreciosComisiones.txt", "w", encoding="UTF-8")        #Genera un archivo de salida
    ...
    salida.write(".............................................\n")
    salida.write("Costo por hora: $%0.2fMXN   \n" %(costoHora))
    salida.write("A continuación podrá ver el costo de cada una de las etapas de sus comisiones \n")
    salida.write(".............................................  \n")
    while indice<j:
        salida.write(dComm[indice])
        salida.write("............  $%0.2f MXN\n" %(costDet[indice]))
        total=total+costDet[indice]
        indice=indice+1
    salida.write("TOTAL .............$%0.2f MXN"%(total))
    salida.close()
...
""")
            print("El costo de sus comisiones ha sido calculado")
            print("""Podrá encontrarlo en el archivo llamado 'PreciosComisiones'
en la carpeta en la que se aloja este programa""")
        elif opcion==2:
